...
### Был выбран `Связный список` так как в плейлисте часто используется добавление и удаление в начало и конец. `Двусвязный` для возможности переключения текущего трека как на слующий, так и на предыдущий трек.
...
```
---
## Вариативный функционал

### `Сохранение` плейлиста в текстовый файл `Base64`
``` cpp
